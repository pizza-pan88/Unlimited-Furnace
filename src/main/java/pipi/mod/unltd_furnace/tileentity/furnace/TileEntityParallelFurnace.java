...
public class TileEntityParallelFurnace extends TileEntityUnltdFurnaceBase {
	public static final Component NAME = Component.translatable("block.unltd_furnace.parallel_furnace");
	
	public TileEntityParallelFurnace(BlockPos pos, BlockState state) {
		super(UnltdFurnaceBlockEntityTypes.PARALLEL_FURNACE.get(), pos, state);
	}
