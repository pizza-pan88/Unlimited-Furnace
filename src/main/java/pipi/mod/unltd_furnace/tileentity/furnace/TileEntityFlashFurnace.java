...
public class TileEntityFlashFurnace extends TileEntityUnltdFurnaceBase {
	public static final Component NAME = Component.translatable("block.unltd_furnace.flash_furnace");
	
	public TileEntityFlashFurnace(BlockPos pos, BlockState state) {
		super(UnltdFurnaceBlockEntityTypes.FLASH_FURNACE.get(), pos, state);
	}
